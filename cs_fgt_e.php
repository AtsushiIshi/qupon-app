...
if(isset($_POST['check_email'])){
  ...
  try{
    ...
    if($result !== false){
      ...
      $_SESSION['cs_email']=$result['customer_email'];
      $_SESSION['flg']="okokok";

      header('Location:cs_email.php');
      exit;
      }else{
    ...
    <header>
      ...
      <main>
        <div class="main-title">
              <h1>会員様の登録メールアドレス確認</h1>
        </div>
        <form class="newform" action="cs_fgt_e.php" method="post">
          <div>
            ...
            <input class="registaration jpletter-space" type="submit" value="メールアドレス確認" name="check_email">      
        </form>
